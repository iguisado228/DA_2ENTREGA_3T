        ...
        public static void erabiltzaileaEzabatu(string nan)
        {
            ...
            try
            {
                ...
                using (MySqlConnection kon = new MySqlConnection(konexioa.konexioKatea()))
                {
                    ...
                    string query = "UPDATE erabiltzaileak SET is_deleted = 1 WHERE nan = @nan";
                    ...
                    using (MySqlCommand cmd = new MySqlCommand(query, kon))
                    {
                        ...
                        if (filasAfectadas > 0)
                        {
                            MessageBox.Show("Erabiltzailean soft-delete egin da.");
                        }
                        else
                        {
            ...
            {
                MessageBox.Show("Errorea erabiltzailean soft-delete egiten: " + ex.Message);
            }
        }
    }
}
